...
final class DemoModel: ObservableObject {
    ...
    @Published private(set) var previewBackgroundColor = UIColor.systemBackground
    ...
    private func render() {
        ...
        do {
            ...
            previewBackgroundColor = DemoRenderer.color(from: theme.globals.background) ?? .systemBackground
            ...
            previewBackgroundColor = .systemBackground
...
private enum DemoRenderer {
    ...
    static func color(from themeColor: ThemeColor?) -> UIColor? {
        guard let rgba = themeColor?.rgba else { return nil }
        return UIColor(
            red: CGFloat(rgba.red) / 255.0,
